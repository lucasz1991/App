 ...
 * Abbildung auf den Bildschirm (center + x * cssSize * 0.42) bleibt gleich.
 *
 * REIHENFOLGE IST BEDEUTUNGSTRAGEND: Die Liste ist per Farthest-Point-
 * Ordnung sortiert, also liegt schon JEDER Anfangsabschnitt gleichmaessig
 * ueber der Form. Der Loader nimmt je nach Geraet 132, 180, 236 oder 300
 * Punkte — dafuer genuegt es, die ersten N zu schneiden. Umsortieren
 * zerstoert diese Eigenschaft.
 *
 * Mischung 3 Kontur : 2 Flaeche. Die Kontur traegt die Erkennbarkeit — dazu
 * gehoert ausdruecklich die Innenkante zwischen T und R, sonst verschwimmen
 * beide Formen zu einem Klecks. Erzeugt von rt-icon-sampler.mjs
 * (archiviert unter .lmzdev/artifacts/partikel-icon/).
 */
const RT_ICON_TARGETS = [
    [-0.3683, -0.1004, 0], [0.6188, 0.6188, 0], [0.4476, -0.4328, 0], [0.1996, -0.0335, 0],
    [-0.6163, 0.6163, 0], [-0.6188, 0.6188, 0], [0.1972, 0.16, 0], [-0.1054, -0.6188, 0],
    [-0.6163, -0.6163, 0], [0.6138, 0.6163, 0], [-0.1004, 0.5865, 1], [-0.6188, -0.5543, 0],
    [-0.6188, 0.2145, 0], [-0.4402, -0.0012, 0], [0.0012, -0.6163, 0], [0.0037, -0.1624, 1],
    [0.2592, 0.584, 0], [0.4476, -0.0831, 0], [-0.1029, 0.4303, 1], [0.4377, -0.4402, 0],
    [-0.3162, 0.3385, 1], [0.2021, -0.6188, 0], [-0.341, -0.4228, 0], [0.2988, 0.3608, 0],
    [-0.1327, -0.2468, 1], [-0.1004, 0.1203, 1], [-0.6188, -0.2567, 1], [0.2096, -0.3236, 1],
    [-0.1153, 0.0905, 1], [-0.4278, 0.336, 0], [0.3708, 0.3509, 0], [-0.3683, 0.5865, 0],
    [0.1054, 0.3906, 0], [-0.6163, -0.284, 1], [-0.3088, -0.5171, 0], [-0.1104, -0.3708, 1],
    [-0.6188, -0.0211, 0], [-0.3683, 0.1228, 0], [0.15, -0.3509, 1], [-0.3137, 0.6163, 1],
    [0.217, -0.1104, 0], [-0.1004, 0.3336, 1], [-0.4179, -0.6188, 0], [0.4452, -0.1624, 0],
    [0.3509, 0.6163, 0], [-0.6188, 0.4154, 0], [0.4948, 0.4848, 0], [0.0608, -0.4228, 0],
    [0.2542, -0.6163, 0], [0.0732, 0.2542, 0], [0.3484, 0.0657, 0], [0.4476, -0.2592, 0],
    [-0.5121, -0.4228, 0], [-0.6163, 0.1748, 0], [-0.3757, -0.2368, 1], [-0.1004, -0.0409, 1],
    [0.4129, 0.6188, 0], [0.3484, -0.5543, 0], [-0.2319, 0.2641, 1], [-0.0012, -0.0856, 0],
    [0.1649, 0.0632, 0], [0.398, 0.3856, 0], [0.1823, -0.3708, 1], [-0.3683, 0.5121, 0],
    [-0.274, -0.4228, 0], [0.4452, -0.0608, 0], [-0.155, -0.3559, 1], [0.0583, -0.1624, 1],
    [0.0062, -0.1104, 0], [-0.3162, 0.279, 1], [-0.1029, 0.3261, 1], [0.212, 0.4104, 0],
    [0.1128, -0.4228, 0], [-0.3708, -0.1624, 1], [-0.0484, -0.1624, 1], [-0.0533, -0.1872, 1],
    [0.1798, -0.2567, 1], [-0.3162, -0.1104, 1], [-0.1004, -0.0955, 1], [-0.1004, 0.0112, 1],
    [0.031, -0.522, 0], [-0.5667, -0.3683, 1], [-0.1004, 0.1724, 1], [-0.1004, 0.279, 1],
    [-0.3683, 0.3336, 0], [-0.6088, -0.1872, 1], [-0.3708, 0.0682, 0], [0.5667, 0.6188, 0],
    [0.0632, -0.3708, 1], [-0.6188, 0.2641, 0], [-0.3708, 0.5369, 0], [0.3534, -0.3906, 0],
    [-0.6188, 0.3633, 0], [-0.6188, 0.465, 0], [-0.3162, 0.47, 1], [0.0558, -0.336, 1],
    [-0.2195, 0.6039, 1], [-0.6188, 0.5667, 0], [0.4625, 0.6188, 0], [0.3137, 0.1004, 0],
    [0.222, -0.527, 0], [0.3633, -0.2096, 0], [-0.4154, -0.1104, 0], [-0.3162, 0.5716, 1],
    [-0.6188, -0.2071, 1], [0.2294, -0.1228, 0], [-0.3137, -0.0062, 1], [0.0136, -0.4228, 0],
    [-0.2344, -0.3708, 1], [-0.5543, -0.1624, 1], [-0.2864, 0.1872, 1], [-0.3708, 0.2616, 0],
    [0.1649, -0.1624, 1], [0.4377, -0.036, 0], [-0.6188, -0.5096, 0], [0.1848, -0.4377, 0],
    [0.2641, 0.584, 0], [0.4476, -0.1277, 0], [0.1054, -0.1104, 0], [-0.3683, 0.2368, 0],
    [-0.279, 0.532, 1], [-0.4129, 0.6163, 0], [0.2864, 0.6188, 0], [0.3782, 0.031, 0],
    [0.4005, 0.3832, 0], [0.2939, 0.2716, 0], [0.4154, 0.5344, 0], [0.4625, 0.4501, 0],
    [0.5816, 0.5791, 0], [0.3212, -0.5865, 0], [-0.2964, -0.279, 1], [-0.3608, -0.589, 0]
];

export function createRailTimeLogoTargets(count) {
    const gewuenscht = Math.max(1, Math.floor(Number(count) || 1));

    // Der Anfangsabschnitt genuegt: die Liste ist bereits so sortiert, dass
    // jede Teilmenge die Form gleichmaessig abdeckt. Sollte je mehr verlangt
    // werden als vorhanden, wird zyklisch weitergezaehlt statt zu haeufen.
    return Array.from({ length: gewuenscht }, (_, index) => {
        const [x, y, ton] = RT_ICON_TARGETS[index % RT_ICON_TARGETS.length];
