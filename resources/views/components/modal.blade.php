...
<div
    ...
    x-show="show"
    id="{{ $id }}"
    class="rt-ui-modal jetstream-modal fixed inset-0 z-[130] overflow-y-auto px-4 py-6 sm:px-0"
    style="display: none;"
>
