...
<div class="flex items-center justify-between gap-3 rounded-lg bg-rt-surface px-3 py-2 text-sm shadow-rt-xs ring-1 ring-rt-border/60 dark:bg-rt-dark-surface dark:ring-rt-dark-border/60">
    ...
    <div class="flex items-center gap-1 flex-shrink-0">
        ...
        @if($previewUrl)
            <a
                href="{{ $previewUrl }}"
                target="_blank"
                class="inline-flex items-center gap-1 rounded-lg border border-rt-border px-2 py-1 text-xs font-medium text-rt-text shadow-rt-xs transition-all duration-300 ease-rt-spring hover:bg-rt-surface-muted active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-rt-red/40 dark:border-rt-dark-border dark:text-rt-dark-text dark:hover:bg-rt-dark-surface-muted"
