...
<x-dropdown align="right" width="48">
    <x-slot name="trigger">
        <button type="button"
                class="rounded-lg border border-gray-200 bg-white px-4 py-2 text-center text-xl font-semibold hover:bg-gray-100 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700">
            &#x22EE;
        </button>
    </x-slot>
