...
<div class="px-2 py-2 text-sm tabular-nums">{{ $item->calendar_reserved }}/{{ $item->required_staff }} besetzt</div>
<div class="px-2 py-2"><x-operations.status :value="$item->status->value" /></div>
