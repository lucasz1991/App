...
<div>
    @if ($paginator->hasPages())
        <nav role="navigation" aria-label="{{ __('pagination.pagination_navigation') }}" class="rt-pagination flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm text-gray-700 leading-5 dark:text-gray-400">
                        <span>{{ __('pagination.showing_results', [
                            'from' => number_format($paginator->firstItem(), 0, app()->getLocale() === 'de' ? ',' : '.', app()->getLocale() === 'de' ? '.' : ','),
                            'to' => number_format($paginator->lastItem(), 0, app()->getLocale() === 'de' ? ',' : '.', app()->getLocale() === 'de' ? '.' : ','),
                            'total' => number_format($paginator->total(), 0, app()->getLocale() === 'de' ? ',' : '.', app()->getLocale() === 'de' ? '.' : ','),
                        ]) }}</span>
                    </p>
                </div>
