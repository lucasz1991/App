                    ...
                    <div class="flex items-center">
                        <div>
                            @if ($session->agent->isDesktop())
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-rt-soft dark:text-rt-dark-soft">
                        ...
                        <div class="ms-3">
                            ...
                            <div>
                                <div class="text-xs text-rt-soft dark:text-rt-dark-soft">
                                    {{ $session->ip_address }},

                                    @if ($session->is_current_device)
                                        <span class="text-emerald-600 dark:text-emerald-400 font-semibold">{{ __('Dieses Gerät') }}</span>
                                    @else
