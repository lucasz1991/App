...
<x-operations.modal wire:model="sectionOpen" title="Dienstabschnitt"><x-operations.feedback /><form wire:submit="saveSection" class="ops-form">
...
<x-operations.modal wire:model="reportOpen" title="Operative Meldung"><x-operations.feedback /><form wire:submit="sendReport" class="ops-form">
...
<x-operations.modal wire:model="resolveOpen" title="Meldung bearbeiten"><x-operations.feedback /><form wire:submit="resolve" class="ops-form">
