    ...
    <div class="px-2 space-y-4">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-4 dark:bg-sky-500/10 dark:border-sky-500 dark:text-sky-300">
            <div class="flex">
                ...
                <div class="ml-3">
                    <div class="text-sm">
                        <p class="font-medium">{{ __('app.tip') }}</p>
                        <p class="mt-1">
                            {{ __('app.employees_tip') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-center">
            <h1 class="text-2xl font-bold text-gray-700 dark:text-white">{{ __('app.employees') }}</h1>
            <span class="ml-2 bg-white text-sky-600 text-xs shadow border border-sky-200 font-bold px-2 py-1 flex items-center justify-center rounded-full h-7 leading-none dark:bg-slate-800 dark:border-slate-700 dark:text-sky-400">
                ...
                <x-dropdown align="left">
                    <x-slot name="trigger">
                        <button
                            type="button"
                            @class([
                                'text-sm border px-3 py-1 rounded-lg relative flex items-center justify-center bg-gray-100 dark:bg-slate-700 dark:border-slate-600',
                                'cursor-not-allowed opacity-50' => $isDisabled,
                                'cursor-pointer' => !$isDisabled,
                            ])
                            @if($isDisabled) disabled @endif
                        >
                            <svg class="w-4 h-4 text-gray-600 dark:text-slate-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="relative">
                    <select 
                        ...
                        class="text-base border border-gray-300 rounded-lg px-2 py-1.5 bg-white shadow-sm focus:ring-2 focus:ring-sky-500 focus:border-sky-500 dark:bg-slate-800 dark:border-slate-600 dark:text-slate-200"
                    >
