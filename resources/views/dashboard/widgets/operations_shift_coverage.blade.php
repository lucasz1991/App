<div x-data="operationsCoverageChart(@js($data))">
    ...
    <div class="ops-chart-canvas" style="height:{{ $size === 'lg' ? '196px' : '140px' }};" x-ref="coverageChart" wire:ignore role="img" aria-label="Besetzung der naechsten sieben Tage: zugesagt gegenueber benoetigt"></div>
</div>
