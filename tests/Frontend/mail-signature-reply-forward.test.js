...
test('mobile rules restyle the same signature nodes without hide-and-show copies', async () => {
    ...
    assert.match(css, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-train-frame,[\s\S]*?tr\[data-rt-artifact-version="v12"\] \.rt-sign-content-frame\s*\{[^}]*height:\s*190px !important;/s);
    ...
    assert.match(mobile, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-train-frame,[\s\S]*?tr\[data-rt-artifact-version="v12"\] \.rt-sign-content-frame\s*\{[^}]*height:\s*296px !important;/s);
    ...
    assert.match(phone, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-train-frame,[\s\S]*?tr\[data-rt-artifact-version="v12"\] \.rt-sign-content-frame\s*\{[^}]*height:\s*264px !important;/s);
    ...
    assert.match(phone, /tr\[data-rt-artifact-version="v12"\] \.rt-sign-train-layer\[data-rt-layer-mobile="stop65"\] \.rt-sign-train\s*\{[^}]*width:\s*135% !important;[^}]*margin-left:\s*-15\.75% !important;/s);
