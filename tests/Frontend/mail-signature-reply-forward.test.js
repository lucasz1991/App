...
test('mobile rules restyle the same signature nodes without hide-and-show copies', async () => {
    ...
    assert.match(mobile, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-train-frame,[\s\S]*?tr\[data-rt-artifact-version="v13"\] \.rt-sign-content-frame\s*\{[^}]*height:\s*296px !important;/s);
    ...
    assert.match(phone, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-train-frame,[\s\S]*?tr\[data-rt-artifact-version="v13"\] \.rt-sign-content-frame\s*\{[^}]*height:\s*264px !important;/s);
