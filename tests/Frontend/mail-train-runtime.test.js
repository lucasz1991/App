...
test('all delivered mail outputs keep the train-first flow overlap and a Classic Outlook IMG', () => {
    ...
    assert.match(builder, /SignatureArtifactVersion::usesSmokeSafeArrivalTrain\(\$artifactVersion\)[\s\S]*?\? 'zug-dampf-v13'[\s\S]*?SignatureArtifactVersion::usesOptimizedArrivalTrain\(\$artifactVersion\)[\s\S]*?\? 'zug-dampf-v12'/);
    assert.doesNotMatch(
        builder.slice(
    ...
    assert.match(phoneCss, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-content,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-content,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-content\s*\{\s*padding-top:\s*14px !important;/);
    assert.match(phoneCss, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-logo,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-logo,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-logo\s*\{\s*padding-bottom:\s*8px !important;/);
...
test('immutable train caching covers the current v12 and v13 asset families', () => {
    const htaccess = text('public/.htaccess');

    assert.match(htaccess, /zug-dampf-v\(\?:12\|13\)-\(light\|dark\)/);
...
test('editor and delivery enlarge the default train progressively while keeping the fixed stage', () => {
    ...
    assert.match(mobile, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-stage,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-stage,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-train-layer,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-stage,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-train-layer,\s*tr\[data-rt-artifact-version="v11"\] \.rt-sign-train-layer\s*\{[^}]*height: 296px !important;[^}]*max-height: 296px !important;/s);
    ...
    assert.match(phone, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-stage,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-stage,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-train-layer,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-stage,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-train-layer,\s*tr\[data-rt-artifact-version="v11"\] \.rt-sign-train-layer\s*\{[^}]*height: 264px !important;[^}]*max-height: 264px !important;/s);
