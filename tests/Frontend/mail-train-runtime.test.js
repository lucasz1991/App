...
test('all delivered mail outputs keep the train-first flow overlap and a Classic Outlook IMG', () => {
    ...
    assert.match(phoneCss, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-content,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-content,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-content,\s*tr\[data-rt-artifact-version="v14"\] \.rt-sign-content\s*\{\s*padding-top:\s*14px !important;/);
    assert.match(phoneCss, /tr\[data-rt-artifact-version="v11"\] \.rt-sign-logo,\s*tr\[data-rt-artifact-version="v12"\] \.rt-sign-logo,\s*tr\[data-rt-artifact-version="v13"\] \.rt-sign-logo,\s*tr\[data-rt-artifact-version="v14"\] \.rt-sign-logo\s*\{\s*padding-bottom:\s*8px !important;/);
...
test('editor and delivery enlarge the default train progressively while keeping the fixed stage', () => {
    ...
    assert.match(responsiveCss, /tr\[data-rt-artifact-version="v14"\]\[data-rt-signature-density="compact"\] \.rt-sign-train,\s*tr\[data-rt-artifact-version="v14"\]\[data-rt-signature-density="compact"\] \.rt-sign-train-mso\s*\{[^}]*width: 94% !important;[^}]*margin-left: 0 !important;/s);
    ...
    assert.match(phone, /tr\[data-rt-artifact-version="v14"\] \.rt-sign-train-layer\[data-rt-layer-mobile="stop65"\] \.rt-sign-train\s*\{[^}]*width: 175% !important;[^}]*margin-left: -40% !important;/s);
