...
namespace {
    ...
    if ($browserTrain !== $browserTrainFixture
        ...
        || ! str_contains($browserTrain, 'style="position:absolute;left:0;right:auto;top:auto;bottom:0;width:100%;max-width:1815px;margin:0;')
        ...
        fwrite(STDERR, "Browser copy train did not preserve the bottom-layer IMG contract.\n");
        exit(1);
    }
...
HTML;
    ...
    // Der Hauptzug bleibt fuer moderne Mailclients ein echtes, am unteren
    // Buehnenrand verankertes IMG. Outlook-Desktop erhaelt davor ein normales
    // Flow-IMG; GIF-Background und VML sind nicht erlaubt.
    $runtimeTrainFixture = <<<'HTML'
<tr><td class="rt-sign-cell" style="padding:0;overflow:hidden;background-image:linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0));background-repeat:no-repeat;background-position:center center;background-size:100% 100%;"><div class="rt-sign-stage" style="position:relative;overflow:hidden;"><div class="rt-sign-train-layer" data-rt-layer-train data-rt-layer-align="left" data-rt-layer-size="100" data-rt-layer-mobile="train" style="position:absolute;left:0;right:auto;top:auto;bottom:0;width:100%;max-width:1815px;margin:0;overflow:hidden;font-size:0;line-height:0;text-align:left;mso-hide:all;"><img class="rt-sign-train" data-rt-train src="https://app.rail-time.de/mail-assets/zug-dampf-light.gif" width="720" alt="" style="position:static;left:auto;right:auto;bottom:auto;display:inline-block;width:100%;max-width:none;height:auto;margin:0;border:0;outline:none;text-decoration:none;vertical-align:top;mso-hide:all;"></div><table style="position:relative;z-index:1;"><tr><td>Inhalt</td></tr></table></div></td></tr><!-- RT_SIGNATURE_MAIN_END -->
HTML;
    ...
    $runtimeChecks = [
        ...
        'bottom layer' => str_contains($runtimeTrain, 'style="position:absolute;left:0;right:auto;top:auto;bottom:0;width:100%;max-width:1815px;margin:0;'),
        ...
        'top idle holder' => str_contains($runtimeTrain, 'style="position:absolute;left:0;right:auto;top:0;bottom:auto;display:block;width:100%;max-width:none;height:0;'),
        'static idle image' => str_contains($runtimeTrain, 'style="position:static;left:auto;right:auto;bottom:auto;display:inline-block;width:100%;max-width:none;'),
    ...
    $size125Train = str_replace(
        [
            ...
            'position:absolute;left:0;right:auto;top:auto;bottom:0;width:100%;max-width:1815px;margin:0;',
    ...
    if (! str_contains($size125Train, 'rt-sign-train-mso')
        || ! str_contains($size125Train, 'position:absolute;left:0;right:auto;top:auto;bottom:0;')
        || ! str_contains($size125Train, 'position:static;left:auto;right:auto;bottom:auto;display:inline-block;width:125%;')) {
        fwrite(STDERR, "Right-aligned 125-percent IMG lost its bottom-layer geometry.\n");
        exit(1);
    }
