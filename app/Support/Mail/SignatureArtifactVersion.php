...
final class SignatureArtifactVersion
{
    ...
    /**
     * V8 bis V14 teilen dieselbe abgeschlossene Zug-Timeline: Das Haupt-GIF
    ...
    {
        return in_array($version, [self::V8, self::V9, self::V10, self::V11, self::V12, self::V13, self::V14], true);
    }
