...
final class TrustedOutlookSignatureCss
{
    ...
    private static function hasIndependentTrainGeometry(?string $artifactVersion): bool
    {
        ...
        return in_array($artifactVersion, [SignatureArtifactVersion::V25, SignatureArtifactVersion::V26, SignatureArtifactVersion::V30], true)
            || SignatureArtifactVersion::usesTableOverlapTrain($artifactVersion);
    }
