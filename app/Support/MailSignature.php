...
class MailSignature
{
    ...
    /**
     * V8 bis V16 sind fachlich markierte Signaturstaende und besitzen eigene
    ...
    private function applyArtifactTrainValues(string $documentHtml, array $values, array $overrides = []): array
    {
        ...
        // V8 bis V16 enthalten ihren vollstaendigen Ankunftsstand bereits im
    ...
    /**
     * V11 bis V16 duerfen die kuerzere Firmenbuehne erst nach dem Entfernen leerer
    ...
    private function applyRuntimeDensityProfile(string $documentHtml, string $renderedHtml): string
    {
        ...
        if ($this->user !== null
            || ! in_array($artifactVersion, [SignatureArtifactVersion::V11, SignatureArtifactVersion::V12, SignatureArtifactVersion::V13, SignatureArtifactVersion::V14, SignatureArtifactVersion::V15, SignatureArtifactVersion::V16], true)) {
            return $renderedHtml;
        }
