...
class MailSignature
{
     ...
     * Renderer benutzt. Die Livevorschau darf dadurch V19-V21-Werte vorab fuer
    ...
    /**
     * V8 bis V21 sind fachlich markierte Signaturstaende und besitzen eigene
    ...
    private function applyArtifactTrainValues(string $documentHtml, array $values, array $overrides = []): array
    {
        ...
        // V8 bis V21 enthalten ihren vollstaendigen Ankunftsstand bereits im
    ...
    private function renderValidatedDocument(
        ...
        if (! SignatureHotline::applies($html) && ! SignatureBackgroundContract::applies($html)) {
    ...
    /**
     * V11 bis V17 duerfen die kuerzere Firmenbuehne erst nach dem Entfernen leerer
    ...
    private function finalizeTrainRendering(
        ...
        // Historische Artefakte behalten ihren versionsgebundenen Vertrag;
        // V21 fuehrt den Hauptzug ohne Ueberlagerung direkt nach dem Inhalt.
