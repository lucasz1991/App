        ...
        return [
            ...
            $this->entry(
                ...
                [
                    ...
                    'Signatur in Outlook: „Outlook-Einrichtung (GUI)“ laden, das ZIP per Rechtsklick vollständig entpacken und den Installer nicht direkt aus der ZIP-Ansicht starten. Die grafische Einrichtung schließt Outlook automatisch, zeigt Erfolg oder Fehler samt Protokoll und weist die Signatur dem ersten @rail-time.de-Konto in Classic Outlook zu. Neues Outlook speichert Signaturen kontogebunden: die enthaltene HTM-Kopiervorlage unter Einstellungen → Konten → Signaturen einfügen.',
                ...
                [
                    ...
                    'Outlook signature: download “Outlook setup (GUI)”, fully extract the ZIP via its context menu, and do not run the installer inside the ZIP view. The graphical setup closes Outlook automatically, shows a logged success or error, and assigns the signature to the first @rail-time.de account in classic Outlook. New Outlook stores signatures per account: paste the included HTM copy template under Settings → Accounts → Signatures.',
