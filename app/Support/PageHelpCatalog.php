    ...
    private function entries(): array
    {
        return [
            ...
            $this->entry(
                ...
                [
                    'Prüfen Sie zuerst den Profilstatus. Die beiden Downloads werden automatisch mit Ihren Kontaktdaten und den zentral gepflegten Firmendaten erstellt.',
                    ...
                    '„Outlook-Paket herunterladen“ enthält Signatur, Anleitung, Prüfsummen sowie den geführten Windows-Installer. Entpacken Sie das ZIP vollständig und starten Sie die CMD-Datei nicht direkt aus der ZIP-Ansicht.',
                    'Classic Outlook wird vom Paket geprüft und automatisch eingerichtet. Das neue Outlook speichert Signaturen kontogebunden: Öffnen Sie die enthaltene HTML-Kopiervorlage und fügen Sie sie unter Einstellungen → Konten → Signaturen ein.',
                    'Apple Mail, Gmail und Thunderbird verwenden ebenfalls die enthaltene HTML-Signatur. Folgen Sie dafür der ausführlichen Anleitung im Outlook-Paket.',
                ...
                [
                    'Check profile status first. Both downloads are generated automatically with your contact details and the centrally maintained company details.',
                    ...
                    '“Download Outlook package” contains the signature, instructions, checksums and guided Windows installer. Fully extract the ZIP and do not run the CMD file inside the ZIP view.',
                    'Classic Outlook is checked and configured automatically by the package. New Outlook stores signatures per account: open the included HTML copy template and paste it under Settings → Accounts → Signatures.',
                    'Apple Mail, Gmail and Thunderbird can also use the included HTML signature. Follow the detailed instructions inside the Outlook package.',
            ...
            $this->entry(
                'Marketing-Motiv-Editor',
                'Marketing creative editor',
                'RailTime-Motive in einem festen Story-, Post- oder Web-Artboard als Vorschau prüfen und ausschließlich im Vollbildeditor bearbeiten.',
                'Review RailTime creatives in a fixed story, post or web artboard and edit them exclusively in the full-screen editor.',
                [
                    'Die Vorschau zeigt das gewählte feste Ausgabeformat; Öffnen Sie den Vollbildmodus, bevor Sie Inhalte oder Gestaltung ändern.',
                    'Blöcke, Ebenen, Abstände, Medien und freigegebene Animationen lassen sich über die Editor-Seitenleisten steuern.',
                    'Bilder stammen ausschließlich aus dem für Marketing freigegebenen Ordner des Firmen-Dateipools.',
                    'Speichern aktualisiert nur den Entwurf. Freigabe, Export und Veröffentlichung bleiben bewusste separate Aktionen außerhalb des Assistenten.',
                ],
                [
                    'The preview shows the selected fixed output format; open full-screen mode before changing content or styling.',
                    'Blocks, layers, spacing, media and approved animations are controlled through the editor sidebars.',
                    'Images come exclusively from the company FilePool folder approved for marketing.',
                    'Saving updates the draft only. Approval, export and publication remain deliberate separate actions outside the assistant.',
                ],
                'Marketing',
                'layout-template',
                ['admin.marketing.creatives.index', 'admin.marketing.creatives.editor'],
                true,
            ),
            $this->entry(
