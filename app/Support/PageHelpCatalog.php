        ...
        return [
            ...
            $this->entry(
                ...
                [
                    ...
                    'Signatur in Outlook: „Für Outlook einrichten“ laden und das ZIP vollständig entpacken. Klassisches Outlook: Outlook schließen und den enthaltenen Installer starten. Neues Outlook: die enthaltene HTM-Kopiervorlage öffnen und unter Einstellungen → Konten → Signaturen einfügen.',
                ...
                [
                    ...
                    'Outlook signature: download “Set up for Outlook” and fully extract the ZIP. Classic Outlook: close Outlook and run the included installer. New Outlook: open the included HTM copy template and paste it under Settings → Accounts → Signatures.',
