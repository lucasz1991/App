    ...
    private function entries(): array
    {
        return [
            ...
            $this->entry(
                'E-Mail-Signaturen',
                'Email signatures',
                'Persönliche Signaturen aus zentralen Firmen- und Profildaten prüfen, kopieren oder herunterladen.',
                'Review, copy or download personal signatures built from central company and profile data.',
                [
                    'Die Vorschau zeigt die aktuelle Signatur vor der Übernahme in Ihr Mailprogramm.',
                    'Fehlende Angaben werden im Profil oder in den zentralen Firmendaten ergänzt.',
                    'Kopieren übernimmt die formatierte Signatur für direktes Einfügen.',
                    'Downloads liefern die für das ausgewählte Mailprogramm geeignete Fassung.',
                ],
                [
                    'The preview shows the current signature before adding it to your mail client.',
                    'Missing details are completed in the profile or central company data.',
                    'Copy transfers the formatted signature for immediate pasting.',
                    'Downloads provide the version suited to the selected mail client.',
                ],
                'Mein Bereich',
                'at-sign',
            ...
            $this->entry(
                'Support',
                'Support',
                'Eine nachvollziehbare Supportanfrage mit Gerätedaten, Ablauf und optionalen Anhängen an das RailTime-Team senden.',
                'Send a traceable support request with device details, steps and optional attachments to the RailTime team.',
                [
                    ...
                    'Screenshots, genaue Fehlermeldungen und Zeitpunkt beschleunigen die Analyse.',
                    'Vermeiden Sie Kennwörter oder andere vertrauliche Zugangsdaten in Text und Anhängen.',
                ],
                [
                    'Describe what you wanted to do and where the problem occurred.',
                    'State the expected result and what actually happened.',
                    'Screenshots, exact error messages and the time of occurrence speed up analysis.',
                    'Do not include passwords or other confidential credentials in text or attachments.',
                ],
                'Hilfe',
                'life-buoy',
                ['support'],
