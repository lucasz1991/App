        ...
        return [
            ...
            $this->entry(
                ...
                [
                    ...
                    'Signatur in Outlook: „Für Outlook einrichten“ laden, das ZIP per Rechtsklick vollständig entpacken und den Installer nicht direkt aus der ZIP-Ansicht starten. Der Batch-Installer gilt nur für klassisches Outlook und zeigt Erfolg oder Fehler samt Protokoll. Neues Outlook speichert Signaturen kontogebunden: die enthaltene HTM-Kopiervorlage unter Einstellungen → Konten → Signaturen einfügen.',
                ...
                [
                    ...
                    'Outlook signature: download “Set up for Outlook”, fully extract the ZIP via its context menu, and do not run the installer inside the ZIP view. The batch installer applies only to classic Outlook and shows a logged success or error. New Outlook stores signatures per account: paste the included HTM copy template under Settings → Accounts → Signatures.',
