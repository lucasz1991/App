...
CSS;
        ...
        $jobCards = <<<'CSS'
.rt-job-card{position:relative;display:flex;min-width:0;overflow:hidden;flex-direction:column;isolation:isolate;border:1px solid rgba(255,255,255,.13);background:radial-gradient(120% 84% at 100% 0,rgba(228,0,43,.11),transparent 58%),linear-gradient(145deg,rgba(19,27,37,.98),rgba(7,10,15,.98));clip-path:polygon(0 0,calc(100% - 11px) 0,100% 11px,100% 100%,0 100%)}.rt-job-card:before{position:absolute;z-index:0;top:0;right:11px;left:0;height:2px;background:linear-gradient(90deg,#e4002b,rgba(228,0,43,.08));content:""}.rt-job-card:after{position:absolute;z-index:-1;right:10px;bottom:-12px;color:#fff;font-family:"Space Mono",monospace;font-size:58px;font-weight:700;line-height:1;opacity:.035}.rt-job-card--tasks:after{content:"01"}.rt-job-card--profile:after{content:"02"}.rt-job-card--benefits:after{content:"03"}.rt-job-card--benefits{background:radial-gradient(125% 90% at 100% 0,rgba(228,0,43,.19),transparent 58%),linear-gradient(145deg,rgba(20,27,37,.98),rgba(7,10,15,.98))}.rt-job-card__head{position:relative;z-index:1;display:flex;align-items:center}.rt-job-card__icon{display:grid;flex:0 0 auto;place-items:center;background:linear-gradient(135deg,#e4002b,#a90023);clip-path:polygon(0 0,calc(100% - 9px) 0,100% 9px,100% 100%,0 100%)}.rt-job-card__icon img{display:block;width:58%;height:58%;object-fit:contain}.rt-job-card__heading{display:grid;min-width:0}.rt-job-card__heading small{color:#e4002b;font-family:"Space Mono",monospace;font-weight:700;letter-spacing:.1em;text-transform:uppercase}.rt-job-card__heading strong{color:#fff;font-weight:750;letter-spacing:-.02em}.rt-job-card .rt-job-card__list{position:relative;z-index:1;display:flex;margin:0;padding:0;flex:1;flex-direction:column;justify-content:space-evenly;list-style:none}.rt-job-card .rt-job-card__list li{position:relative;margin:0;padding-left:22px;border-top:1px solid rgba(255,255,255,.075);color:#e2e7eb;font-weight:550}.rt-job-card .rt-job-card__list li:before{position:absolute;top:.72em;left:2px;width:7px;height:4px;border-right:2px solid #e4002b;border-bottom:2px solid #e4002b;background:none;content:"";transform:rotate(45deg)}
CSS;
...
.rt-job-premium-story{background:#090c11;color:#fff}.rt-job-premium-story:before{z-index:2;background-image:linear-gradient(rgba(255,255,255,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px)}.rt-job-premium-story .rt-photo{inset:0 0 auto;height:1060px;background:#090c11}.rt-job-premium-story .rt-photo:after{position:absolute;inset:0;background:linear-gradient(180deg,rgba(9,12,17,.18),rgba(9,12,17,.04) 33%,#090c11 96%),linear-gradient(90deg,rgba(9,12,17,.5),transparent 68%);content:""}.rt-job-premium-story .rt-photo img{object-position:31% center}.rt-job-premium-story .rt-mast{top:104px;right:58px;left:58px;display:flex;align-items:center;justify-content:space-between}.rt-job-premium-story .rt-brand-lockup{width:260px}.rt-job-premium-story .rt-code,.rt-job-premium-story .rt-kicker{color:#fff;font-size:18px}.rt-job-premium-story .rt-copy{top:420px;right:58px;left:58px}.rt-job-premium-story h1{max-width:900px;margin-top:18px;font-size:108px;line-height:.86}.rt-job-premium-story .rt-subtitle{max-width:800px;margin-top:25px;font-size:30px;line-height:1.2}.rt-job-premium-story .rt-job-panel{position:absolute;z-index:3;top:895px;right:58px;left:58px}.rt-job-premium-story .rt-intro{max-width:940px;color:#cbd2d8;font-size:23px;line-height:1.42}.rt-job-premium-story .rt-facts{margin-top:24px;grid-template-columns:repeat(3,1fr);border-top:1px solid rgba(255,255,255,.18);border-bottom:1px solid rgba(255,255,255,.18)}.rt-job-premium-story .rt-facts>div{min-height:108px;padding:18px;border-right:1px solid rgba(255,255,255,.18)}.rt-job-premium-story .rt-facts>div:last-child{border:0}.rt-job-premium-story .rt-facts strong{color:#fff;font-size:40px}.rt-job-premium-story .rt-facts span{margin-top:7px;color:#aeb7c0;font-size:15px;text-transform:uppercase}.rt-job-premium-story .rt-job-details{margin-top:29px;grid-template-columns:repeat(3,minmax(0,1fr));gap:25px}.rt-job-premium-story .rt-job-details article+article{padding-left:25px;border-left:1px solid rgba(255,255,255,.18)}.rt-job-premium-story .rt-job-details article>span{font-size:13px}.rt-job-premium-story .rt-job-details ul{margin-top:15px;gap:10px}.rt-job-premium-story .rt-job-details li{font-size:15.5px;line-height:1.32}.rt-job-premium-story footer{right:0;bottom:0;left:0;display:flex;height:440px;padding:52px 58px;align-items:flex-start;isolation:isolate;border-top:3px solid #e4002b;background-image:linear-gradient(rgba(255,255,255,.024) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.024) 1px,transparent 1px),radial-gradient(70% 180% at 96% 48%,rgba(228,0,43,.2),transparent 62%),linear-gradient(112deg,#111923 0,#0c1119 54%,#070a0f 100%);background-size:54px 54px,54px 54px,auto,auto;color:#fff}.rt-job-premium-story footer:before{position:absolute;z-index:-1;inset:0;background:linear-gradient(116deg,transparent 0 57%,rgba(228,0,43,.32) 57.2% 57.55%,transparent 57.8%);content:""}.rt-job-premium-story footer:after{position:absolute;z-index:-1;right:58px;bottom:9px;width:390px;height:390px;background:url("/rt-brand/rt-logo.svg") center/contain no-repeat;content:"";filter:grayscale(1) brightness(3);opacity:.055}.rt-job-premium-story footer>div{display:grid;margin-left:auto;text-align:right;gap:9px}.rt-job-premium-story .rt-cta{font-size:16px}.rt-job-premium-story footer strong{color:#fff;font-size:24px}.rt-job-premium-story footer span{color:#b7c1ca;font-size:18px}
CSS,
            [MarketingTemplateFactory::PREMIUM_JOB_WAGENMEISTER, MarketingCreativeFormat::Post] => <<<'CSS'
.rt-job-premium-post{background:#090c11;color:#fff}.rt-job-premium-post .rt-photo{top:0;right:0;width:58%;height:820px}.rt-job-premium-post .rt-photo:after{position:absolute;inset:0;background:linear-gradient(90deg,#090c11 0,transparent 34%),linear-gradient(0deg,#090c11 0,transparent 25%);content:""}.rt-job-premium-post .rt-photo img{object-position:42% center}.rt-job-premium-post .rt-mast{top:42px;right:48px;left:48px;display:flex;align-items:center;justify-content:space-between}.rt-job-premium-post .rt-brand-lockup{width:230px}.rt-job-premium-post .rt-code{color:#fff}.rt-job-premium-post .rt-copy{top:178px;left:48px;width:650px}.rt-job-premium-post h1{margin-top:12px;font-size:70px;line-height:.88}.rt-job-premium-post .rt-subtitle{max-width:570px;margin-top:16px;font-size:23px}.rt-job-premium-post .rt-intro{max-width:570px;margin-top:15px;color:#c4ccd3;font-size:15px;line-height:1.42}.rt-job-premium-post>.rt-job-details{position:absolute;z-index:4;top:520px;right:48px;left:48px;padding:23px 24px 25px;border-top:3px solid #e4002b;background:rgba(9,12,17,.94);grid-template-columns:repeat(3,minmax(0,1fr));gap:22px}.rt-job-premium-post .rt-job-details article+article{padding-left:22px;border-left:1px solid rgba(255,255,255,.18)}.rt-job-premium-post .rt-job-details article>span{font-size:10.5px}.rt-job-premium-post .rt-job-details ul{margin-top:12px;gap:7px}.rt-job-premium-post .rt-job-details li{font-size:12.5px;line-height:1.27}.rt-job-premium-post footer{right:0;bottom:0;left:0;display:flex;height:245px;padding:34px 48px;align-items:flex-start;background-image:linear-gradient(rgba(255,255,255,.024) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.024) 1px,transparent 1px),radial-gradient(70% 180% at 96% 48%,rgba(228,0,43,.2),transparent 62%),linear-gradient(112deg,#111923 0,#0c1119 54%,#070a0f 100%);background-size:54px 54px,54px 54px,auto,auto;color:#fff}.rt-job-premium-post footer:before{position:absolute;top:0;right:48px;left:48px;height:3px;background:#e4002b;content:""}.rt-job-premium-post footer .rt-facts{width:540px;grid-template-columns:repeat(3,1fr)}.rt-job-premium-post .rt-facts>div{padding-right:17px;border-right:1px solid rgba(255,255,255,.18)}.rt-job-premium-post .rt-facts>div+div{padding-left:17px}.rt-job-premium-post .rt-facts strong{color:#fff;font-size:31px}.rt-job-premium-post .rt-facts span{margin-top:5px;color:#b7c1ca;font-size:10px;text-transform:uppercase}.rt-job-premium-post footer .rt-cta{min-height:50px;margin-left:auto;padding:0 19px;font-size:11px}.rt-job-premium-post footer>strong{position:absolute;right:48px;bottom:26px;color:#fff;font-size:12px}
CSS,
            [MarketingTemplateFactory::PREMIUM_JOB_WAGENMEISTER, MarketingCreativeFormat::Web] => <<<'CSS'
.rt-job-premium-web{background:#090c11;color:#fff}.rt-job-premium-web .rt-copy{top:0;bottom:0;left:0;width:72%;padding:27px 42px}.rt-job-premium-web .rt-brand-lockup{width:165px}.rt-job-premium-web .rt-kicker{margin-top:14px;font-size:9px}.rt-job-premium-web h1{margin-top:7px;font-size:46px;line-height:.88}.rt-job-premium-web .rt-subtitle{max-width:690px;margin-top:9px;font-size:17px}.rt-job-premium-web .rt-intro{max-width:735px;margin-top:9px;color:#c3cbd2;font-size:11.5px;line-height:1.38}.rt-job-premium-web .rt-job-details{margin-top:13px;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.rt-job-premium-web .rt-job-details article+article{padding-left:14px;border-left:1px solid rgba(255,255,255,.18)}.rt-job-premium-web .rt-job-details article>span{font-size:8.5px}.rt-job-premium-web .rt-job-details ul{margin-top:7px;gap:4px}.rt-job-premium-web .rt-job-details li{padding-left:13px;font-size:10.5px;line-height:1.23}.rt-job-premium-web .rt-job-details li:before{width:6px}.rt-job-premium-web .rt-actions{margin-top:14px}.rt-job-premium-web .rt-cta{min-height:42px;padding:0 17px;font-size:9.5px}.rt-job-premium-web .rt-actions strong{font-size:10px}.rt-job-premium-web .rt-photo{top:0;right:0;width:36%;height:630px}.rt-job-premium-web .rt-photo:after{position:absolute;inset:0;background:linear-gradient(90deg,#090c11 0,transparent 29%),linear-gradient(0deg,rgba(9,12,17,.72),transparent 50%);content:""}.rt-job-premium-web .rt-photo img{object-position:42% center}.rt-job-premium-web .rt-photo figcaption{right:19px;bottom:18px;font-size:8px}.rt-job-premium-web footer{right:18px;bottom:54px;width:365px;padding:14px 15px;border-top:2px solid #e4002b;background-image:linear-gradient(rgba(255,255,255,.024) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.024) 1px,transparent 1px),radial-gradient(70% 180% at 96% 48%,rgba(228,0,43,.2),transparent 62%),linear-gradient(112deg,#111923 0,#0c1119 54%,#070a0f 100%);background-size:42px 42px,42px 42px,auto,auto}.rt-job-premium-web footer .rt-facts{grid-template-columns:repeat(3,1fr)}.rt-job-premium-web .rt-facts strong{font-size:20px}.rt-job-premium-web .rt-facts span{margin-top:3px;color:#fff;font-size:7.5px;text-transform:uppercase}
CSS,
...
CSS,
        ...
        $jobCardSpecific = match ([$templateKey, $format]) {
            [MarketingTemplateFactory::PREMIUM_JOB_WAGENMEISTER, MarketingCreativeFormat::Story] => <<<'CSS'
.rt-job-premium-story .rt-job-panel{top:875px}.rt-job-premium-story .rt-job-details{height:430px;margin-top:24px;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.rt-job-premium-story .rt-job-details .rt-job-card{padding:20px 20px 18px;border:1px solid rgba(255,255,255,.13)}.rt-job-premium-story .rt-job-card__head{gap:14px}.rt-job-premium-story .rt-job-card__icon{width:48px;height:48px}.rt-job-premium-story .rt-job-card__heading small{font-size:10px}.rt-job-premium-story .rt-job-card__heading strong{margin-top:4px;font-size:16.5px;line-height:1.1}.rt-job-premium-story .rt-job-card__list{margin-top:14px}.rt-job-premium-story .rt-job-card__list li{display:flex;min-height:44px;padding:8px 0 8px 24px;align-items:center;font-size:15.2px;line-height:1.32}.rt-job-premium-story .rt-job-card__list li:before{top:50%;transform:translateY(-60%) rotate(45deg)}.rt-job-premium-story footer{height:340px;align-items:center}
CSS,
            [MarketingTemplateFactory::PREMIUM_JOB_WAGENMEISTER, MarketingCreativeFormat::Post] => <<<'CSS'
.rt-job-premium-post>.rt-job-details{top:493px;bottom:265px;padding:0;border:0;background:none;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.rt-job-premium-post .rt-job-details .rt-job-card{padding:17px 18px;border:1px solid rgba(255,255,255,.13)}.rt-job-premium-post .rt-job-card__head{gap:12px}.rt-job-premium-post .rt-job-card__icon{width:40px;height:40px}.rt-job-premium-post .rt-job-card__heading small{font-size:9px}.rt-job-premium-post .rt-job-card__heading strong{margin-top:3px;font-size:14px;line-height:1.1}.rt-job-premium-post .rt-job-card__list{margin-top:12px}.rt-job-premium-post .rt-job-card__list li{display:flex;min-height:39px;padding:6px 0 6px 20px;align-items:center;font-size:12.8px;line-height:1.27}.rt-job-premium-post .rt-job-card__list li:before{top:50%;transform:translateY(-60%) rotate(45deg)}.rt-job-premium-post .rt-job-card:after{font-size:42px}
CSS,
            [MarketingTemplateFactory::PREMIUM_JOB_WAGENMEISTER, MarketingCreativeFormat::Web] => <<<'CSS'
.rt-job-premium-web .rt-job-details{width:725px;height:279px;margin-top:11px;grid-template-columns:repeat(2,minmax(0,1fr));grid-template-rows:158px 112px;gap:9px 10px}.rt-job-premium-web .rt-job-details .rt-job-card{padding:10px 12px;border:1px solid rgba(255,255,255,.13)}.rt-job-premium-web .rt-job-details .rt-job-card+.rt-job-card{padding-left:12px}.rt-job-premium-web .rt-job-card__head{gap:9px}.rt-job-premium-web .rt-job-card__icon{width:32px;height:32px}.rt-job-premium-web .rt-job-card__heading small{font-size:7.5px}.rt-job-premium-web .rt-job-card__heading strong{margin-top:2px;font-size:10.5px;line-height:1.08}.rt-job-premium-web .rt-job-card__list{margin-top:6px}.rt-job-premium-web .rt-job-card__list li{display:flex;min-height:24px;padding:4px 0 4px 17px;align-items:center;font-size:10.2px;line-height:1.2}.rt-job-premium-web .rt-job-card__list li:before{top:50%;left:1px;width:6px;height:3px;transform:translateY(-60%) rotate(45deg)}.rt-job-premium-web .rt-job-card--benefits{display:grid;grid-column:1/-1;grid-template-columns:150px minmax(0,1fr);grid-template-rows:1fr}.rt-job-premium-web .rt-job-card--benefits .rt-job-card__head{height:100%;padding-right:12px;border-right:1px solid rgba(255,255,255,.09)}.rt-job-premium-web .rt-job-card--benefits .rt-job-card__list{display:grid;margin:0 0 0 13px;grid-template-columns:repeat(2,minmax(0,1fr));gap:0 14px}.rt-job-premium-web .rt-job-card--benefits .rt-job-card__list li{min-height:38px}.rt-job-premium-web .rt-job-card:after{font-size:28px}.rt-job-premium-web .rt-actions{margin-top:12px}
CSS,
            default => '',
        };
