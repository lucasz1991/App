...
.rt-role-post{background:#f4f1ea}.rt-role-post>header{position:absolute;z-index:2;top:0;left:0;width:62%;height:650px;padding:45px 72px 45px 52px;background:#f4f1ea;clip-path:polygon(0 0,100% 0,86% 100%,0 100%)}.rt-role-post .rt-brand-lockup{width:230px}.rt-role-post .rt-kicker{margin-top:65px}.rt-role-post h1{margin-top:11px;font-size:64px;line-height:.9;letter-spacing:-.05em}.rt-role-post .rt-subtitle{margin-top:19px;font-size:24px;line-height:1.18}.rt-role-post>.rt-photo{position:absolute;top:0;right:0;width:53%;height:650px;background:#102237}.rt-role-post>.rt-photo img{object-position:center 32%}.rt-role-post .rt-role-body{position:absolute;right:0;bottom:100px;left:0;height:370px;padding:35px 54px;background:#102237;color:#fff}.rt-role-post .rt-intro{max-width:880px;color:#e2e8ed;font-size:18px}.rt-role-post .rt-facts{margin-top:25px}.rt-role-post .rt-facts>div{flex:1}.rt-role-post .rt-facts strong{color:#d71932;font-size:34px}.rt-role-post .rt-facts span{margin-top:5px;font-size:14px}.rt-role-post .rt-cta{position:absolute;right:54px;bottom:34px}.rt-role-post>footer{position:absolute;right:0;bottom:0;left:0;display:flex;height:100px;padding:0 54px;align-items:center;justify-content:space-between}.rt-role-post>footer span{font-size:12px;font-weight:900;letter-spacing:.16em}.rt-role-post>footer strong{font-size:15px}
CSS,
