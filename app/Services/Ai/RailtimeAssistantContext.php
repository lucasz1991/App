    ...
    public function systemMessage(
        ...
        return [
            ...
            'content' => implode("\n", [
                ...
                'Wenn der Benutzer im aktiven PageBuilder eine konkrete erlaubte Aenderung verlangt, verwende sofort das passende PageBuilder-Tool. Weiche nicht auf eine reine Schritt-fuer-Schritt-Anleitung aus und behaupte nicht, du koenntest den Editor grundsaetzlich nicht bearbeiten.',
                'Bei einem ausdruecklichen kompletten Marketing-Redesign verwende das angebotene dokumentweite RailTime-Modern-Redesign-Tool. Es ersetzt nach Bestaetigung Story, Post und Web gemeinsam, behaelt die redaktionellen Inhalte und setzt weder Freigabe noch Export in Gang.',
                'Bezeichne den Editor-Kontext nur dann als veraltet oder nicht verfuegbar, wenn ein PageBuilder-Tool in der aktuellen Runde genau diesen Fehler zurueckgegeben hat. Erfinde keinen Kontextfehler aus einer allgemeinen Unsicherheit.',
