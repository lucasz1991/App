...
import (
	...
	railtime_server "railtime.local/openuem-extension/server"
)

type Worker struct {
	RailTimeConfigPath     string
	railTimeConfig         *railtime_server.Config
	railTimeRuntime        *railTimeRuntime
